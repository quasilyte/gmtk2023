...
func InitState(ctx *ge.Context, state *session.State) {
	...
	tankTextureTasks := []textureConfig{
		...
		{assets.ImageTankBodyNormal, 3, 1, &gamedata.NormalBodyStats.Texture},
		{assets.ImageTankBodyCreepHeavy, 3, 1, &gamedata.CreepHeavyBodyStats.Texture},
		...
		{assets.ImageTankTurretAssaultLaser, 2, 2, &gamedata.AssaultLaserStats.Texture},
